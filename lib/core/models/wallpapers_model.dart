class WallPapersData {
  ...
  late final List<WallPaperPhotos>? photos;
  late final int? totalResults;
  late final String? nextPage;
  
  WallPapersData.fromJson(Map<String, dynamic> json){
    page = json['page'];
    perPage = json['per_page'];
    photos = List.from(json['photos']).map((e)=>WallPaperPhotos.fromJson(e)).toList();
...
class WallPaperPhotos {
  ...
  late final WallPaperSrc? src;
  late final bool? liked;
  late final String? alt;
  
  WallPaperPhotos.fromJson(Map<String, dynamic> json){
    id = json['id'];
    width = json['width'];
    height = json['height'];
    url = json['url'];
    ...
    src = WallPaperSrc.fromJson(json['src']);
    liked = json['liked'];
    alt = json['alt'];
  }
...
class WallPaperSrc {
  ...
  WallPaperSrc.fromJson(Map<String, dynamic> json){
